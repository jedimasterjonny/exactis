...
| ------------ | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `atoms/`     | one presentational job, composes nothing of ours | `delta-value`, `empty-state`, `field`, `figure-input`, `labelled-switch`, `note`, `screen-body`, `screen-header`, `section-header`, `span-bar`, `tile-grid`                         |
| `molecules/` | atoms combined into one reusable control         | `app-nav`, `edit-dialog`, `money-field`, `rate-field`, `select-field`, `stat-tile`, `term-field`, `text-field`, `theme-toggle`, `year-field`                                        |
