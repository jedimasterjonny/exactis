...
import { accounts, expenseLines } from "./schema";
...
function linkOf(table: typeof accounts | typeof expenseLines): {
...
describe("schema", () => {
  it("points a loan's link and a line's link at the accounts' id", () => {
