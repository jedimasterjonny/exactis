...
| `molecules/` | atoms combined into one reusable control         | `app-nav`, `confirm-dialog`, `edit-dialog`, `money-field`, `month-field`, `rate-field`, `row-actions`, `select-field`, `stat-tile`, `term-field`, `text-field`, `theme-toggle`, `year-field`                                                                                                                              |
