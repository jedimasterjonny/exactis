...
| `organisms/` | a whole region of a screen                       | `account-dialog`, `account-fields`, `account-ledger`, `account-table`, `car-dialog`, `car-fields`, `cash-flow-card`, `expense-schedule`, `house-dialog`, `house-fields`, `income-schedule`, `line-fields`, `progress-points`, `projection-chart`, `schedule-rows` |
| `templates/` | the shell a page sits in                         | `app-frame`                                                                                                                                                                                                                                                       |

A component composes what is below it, and beside it, never above.
Organism-on-organism is the one same-tier edge this allows, and there are eleven
...
`car-fields`, `house-dialog` on `house-fields`, and each of the two schedules on
both `line-fields` and `schedule-rows`.
